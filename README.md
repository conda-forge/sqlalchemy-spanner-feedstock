About sqlalchemy-spanner-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/sqlalchemy-spanner-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/sqlalchemy-spanner-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add sqlalchemy-spanner
# for installing globally
pixi global install sqlalchemy-spanner
```
...
It is possible to list all of the versions of `sqlalchemy-spanner` available on your platform:
...
```
pixi search sqlalchemy-spanner --channel conda-forge
```
